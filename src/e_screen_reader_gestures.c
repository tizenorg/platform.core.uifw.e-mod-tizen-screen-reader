...
static void
_cb_mouse_down(void *data EINA_UNUSED, Evas *e, Evas_Object *o EINA_UNUSED, void *event)
{
   ...
   DEBUG("mouse down: multi.device: %d, taps: %d", ev->multi.device, cover->n_taps);
...
static void
_cb_mouse_up(void *data EINA_UNUSED, Evas *e, Evas_Object *o EINA_UNUSED, void *event)
{
   Ecore_Event_Mouse_Button *ev = event;
   ...
   DEBUG("mouse up, multi.device: %d, taps: %d", ev->multi.device, cover->n_taps);
...
static void
_cb_mouse_move(void *data EINA_UNUSED, Evas *e, Evas_Object *o EINA_UNUSED, void *event)
{
...
_events_init()
{
   evas_object_event_callback_add(cover->gesture_rect, EVAS_CALLBACK_MOUSE_DOWN, _cb_mouse_down, NULL);
   evas_object_event_callback_add(cover->gesture_rect, EVAS_CALLBACK_MOUSE_UP, _cb_mouse_up, NULL);
   evas_object_event_callback_add(cover->gesture_rect, EVAS_CALLBACK_MOUSE_MOVE, _cb_mouse_move, NULL);
...
_resize_gesture_rectangle(Ecore_Evas *ee EINA_UNUSED)
{
   ...
   evas_object_geometry_set(gesture_rectangle, x, y, 400, 500);
   // For testing please use below since repeat events api not working
...
_gesture_init()
{
   ...
   evas_object_repeat_events_set(gesture_rectangle, EINA_TRUE); // Not working, remove later
   _resize_gesture_rectangle(NULL);
   evas_object_color_set(gesture_rectangle, 255, 0, 0, 128);
